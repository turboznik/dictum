...
- **Child ticket**: a GitHub sub-issue linked to the map. Where sub-issues are unavailable, use the map’s task list and put `Part of #<map>` atop the child. Apply a `wayfinder:<type>` label.
