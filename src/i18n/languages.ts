...
> = {
  ...
  vi: { name: "Vietnamese", nativeName: "Tiếng Việt", priority: 8 },
  pl: { name: "Polish", nativeName: "Polski", priority: 9 },
  it: { name: "Italian", nativeName: "Italiano", priority: 10 },
  ru: { name: "Russian", nativeName: "Русский", priority: 11 },
  uk: { name: "Ukrainian", nativeName: "Українська", priority: 12 },
  pt: { name: "Portuguese", nativeName: "Português", priority: 13 },
  cs: { name: "Czech", nativeName: "Čeština", priority: 14 },
  tr: { name: "Turkish", nativeName: "Türkçe", priority: 15 },
  ar: { name: "Arabic", nativeName: "العربية", priority: 16, direction: "rtl" },
};
